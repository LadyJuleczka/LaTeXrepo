...
var friendconnect_serverVersion = "0.1-4288b2a0_2f31a36d_9f343935_5abd58af_693f5b0a.7";
...
fc3[fc].da=function(a){fcfb(this.constraints,a||{});fcfb(this.skin,this.constraints);if(this.bar.fixedIeSizes&&this.constraints[fcta]&&this.constraints[fcqa]){a=this.bar.Cb();var b=this.constraints[fcta],c=this.constraints[fcqa];a-=b+c;a%2&&(--a,this.skin.right=this.skin[fcqa]+1);fcj(this.skin,a);delete this.skin[fcta]}};
...
google.friendconnect.container.setServerBase('http://www-a-fc-opensocial.googleusercontent.com/ps/');google.friendconnect.container.setServerVersion('0.1-4288b2a0_2f31a36d_9f343935_5abd58af_693f5b0a.7');google.friendconnect.container.setApiVersion('0.8');
...
google.friendconnect.container.setDateStamp_('14add3b6a25');